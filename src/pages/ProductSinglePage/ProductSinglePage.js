              ...
              <div className="product-details font-manrope">
                ...
                <div className="info flex align-center flex-wrap fs-14">
                  <div className="rating">
                    <span className="text-blue fw-5">Rating:</span>
                    <span className="mx-1">{product?.rating}</span>
                  </div>
                  <div className="vert-line"></div>
                  <div className="brand">
                    <span className="text-blue fw-5">Brand:</span>
                    <span className="mx-1">{product?.brand}</span>
                  </div>
                  <div className="vert-line"></div>
                  <div className="brand">
                    <span className="text-blue fw-5">Category:</span>
                ...
                <div className="price">
                  ...
                  <div className="flex align-center my-1">
                    <div className="new-price fw-5 font-poppins fs-24 text-blue">
                      {formatPrice(discountedPrice)}
                    </div>
                    <div className="discount bg-blue fs-13 text-white fw-6 font-poppins">
